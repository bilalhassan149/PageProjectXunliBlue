<template name="yq-avatar">
	<view>
		<!-- 头像 -->
		<!-- <view class="hide-bor" v-show="show==true">
			<view class="hide-bor1">
				<view class="hide-re">
					<view class="user-img">
						<view @click="fSelect" >相册</view>
						<view @click="images('camera')" >拍照</view>
					</view>
					<view class="btn-h" @click="show = false" style="margin:40rpx 0 40rpx 0 ;">取消</view>
				</view>
			</view> 
		</view> -->
		...
		methods: {
			...
			images(e){
				...
				uni.chooseImage({
					...
					sourceType: [e],//['camera','album'], //这要注意，camera拍照，album是打开手机相册
					success: (res)=> {
						console.log(res);
